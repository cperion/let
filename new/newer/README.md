...
| `U64`, `I64` and `F64` | **specified in `syntax.md` §1, not implemented yet**: two 32-bit words with the integer rules, and IEEE-754 double with the float rules. This is the next thing to build, in that order |

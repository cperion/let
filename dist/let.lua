-- Generated by bundle.lua from 25 modules. Do not edit.
--
...
if script and this == script and arg[1] then
    ...
    if arg[2] then
        local handle = assert(io.open(arg[2], 'wb')); handle:write(source); handle:close()
    else io.write(source) end
elseif script and this == script then
    io.stderr:write("usage: luajit let.lua input.let [output.c [options.lua]]\n")
    os.exit(1)
else
    return V
end

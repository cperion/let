...
b1:;
        ...
        let_run_3();
        struct let_val_1 v1_7_0 = ((struct let_val_1){v1_2_0, v1_4_0, INT64_C(0), INT64_C(0)});
...
static int64_t let_run_3(void) {
    {
        goto b1;
b1:;
        int64_t v1_2_0 = open(INT64_C(3));
        int64_t v1_4_0 = open(INT64_C(4));
        struct let_val_2 v1_5_0 = ((struct let_val_2){v1_2_0, v1_4_0});
        int64_t v1_7_0 = (v1_5_0).f1;
        close(v1_7_0);
        int64_t v1_9_0 = (v1_5_0).f0;
        close(v1_9_0);
        return INT64_C(0);
    }
}

...
extern void close_buffer(int64_t a0);
...
static int64_t let_drop_4(int64_t p1_1);
...
b1:;
        ...
        struct let_val_2 v1_4_0 = ((struct let_val_2){INT64_C(0), ((struct let_val_1){INT64_C(0)}), v1_3_0});
        return ((struct let_ret_1){v1_4_0, v1_4_0});
    }
}
...
static int64_t let_run_3(void) {
    {
        goto b1;
b1:;
        int64_t v1_2_0 = open_buffer(INT64_C(8));
        int64_t v1_3_0 = v1_2_0;
        return let_drop_4(v1_3_0);
    }
}

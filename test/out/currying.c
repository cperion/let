...
static uint8_t let_show_6(int64_t p1_1, int64_t p1_2, int64_t p1_3);

static uint8_t let_show_6_2(void);
...
b1:;
        let_show_6_2();
        return ((struct let_ret_1){((struct let_val_4){INT64_C(0), ((struct let_val_1){INT64_C(2)}), ((struct let_val_2){INT64_C(6), INT64_C(7)}), INT64_C(42), INT64_C(42), INT64_C(42), ((struct let_val_3){INT64_C(42), INT64_C(42), INT64_C(42)}), INT64_C(0)}), ((struct let_val_4){INT64_C(0), ((struct let_val_1){INT64_C(2)}), ((struct let_val_2){INT64_C(6), INT64_C(7)}), INT64_C(42), INT64_C(42), INT64_C(42), ((struct let_val_3){INT64_C(42), INT64_C(42), INT64_C(42)}), INT64_C(0)})});
    }
}

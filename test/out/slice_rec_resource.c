...
struct let_s1 let_module_init(void) {
    {
        ...
        struct let_s3 v5 = let_f_advance_0(v4, INT64_C(3));
...
b2:;
        struct let_s4 b2_v3 = let_made_advance_0(b2_p2, b2_p1);
        Handle b2_v4 = let_made_run(b2_v3);
        int64_t b2_v7 = ((int64_t)(((uint64_t)b2_p1) - ((uint64_t)INT64_C(1))));
        struct let_s2 b2_v8 = let_f_construct(b2_p2);
        struct let_s3 b2_v9 = let_f_advance_0(b2_v8, b2_v7);
        int64_t b2_v10 = let_f_run(b2_v9);
        int64_t b2_v11 = ((int64_t)(((uint64_t)INT64_C(1)) + ((uint64_t)b2_v10)));
        release(b2_v4);
        return b2_v11;
b3:;
        return INT64_C(0);

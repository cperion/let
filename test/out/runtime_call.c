...
static int64_t let_multiply_3(int64_t p1_1, int64_t p1_2);

static int64_t let_multiply_3_2(int64_t p1_1);
...
extern struct let_ret_1 let_module_init(void) {
    {
        goto b1;
b1:;
        int64_t v1_3_0 = runtime_int(INT64_C(6));
        int64_t v1_7_0 = let_multiply_3_2(v1_3_0);
        struct let_val_1 v1_8_0 = ((struct let_val_1){v1_7_0});
        let_show_4(v1_7_0);
        struct let_val_2 v1_10_0 = ((struct let_val_2){INT64_C(0), v1_3_0, v1_7_0, v1_8_0, INT64_C(0)});
        return ((struct let_ret_1){v1_10_0, v1_10_0});
    }
}
...
static int64_t let_multiply_3(int64_t p1_1, int64_t p1_2) {
    {
        goto b1;
b1:;
        int64_t v1_1_0 = LET_MUL(p1_1, p1_2);
        return v1_1_0;
    }
}
...
static int64_t let_multiply_3_2(int64_t p1_1) {
    {
        goto b1;
b1:;
        int64_t v1_1_0 = LET_MUL(p1_1, INT64_C(7));
        return v1_1_0;
    }
}

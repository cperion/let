...
struct let_s1 let_module_init(void) {
    {
        int64_t v2 = INT64_C(0);
        struct let_s2 v3 = let_inc_construct((&v2));
        struct let_s2 v5 = let_inc_construct((&v2));
        struct let_s3 v6 = let_inc_advance_0(v5, INT64_C(1));
        int64_t v7 = let_inc_run(v6);
        struct let_s2 v9 = let_inc_construct((&v2));
        struct let_s3 v10 = let_inc_advance_0(v9, INT64_C(1));
        int64_t v11 = let_inc_run(v10);
        struct let_s1 v12 = ((struct let_s1){(&v2), v3, v7, v11});
        return v12;
    }
}

...
b1:;
        ...
        int64_t v1_7_0 = open(INT64_C(3));
        int64_t v1_9_0 = open(INT64_C(4));
        struct let_val_3 v1_10_0 = ((struct let_val_3){v1_7_0, v1_9_0});
        struct let_val_4 v1_11_0 = ((struct let_val_4){v1_10_0});
        struct let_val_3 v1_13_0 = (v1_11_0).f0;
        int64_t v1_14_0 = (v1_13_0).f1;
        close(v1_14_0);
        int64_t v1_16_0 = (v1_13_0).f0;
        close(v1_16_0);
        int64_t v1_18_0 = (v1_5_0).f1;
        close(v1_18_0);
        int64_t v1_20_0 = (v1_5_0).f0;
        close(v1_20_0);
        return INT64_C(0);
    }
}

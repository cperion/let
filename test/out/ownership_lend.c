...
extern void consume_buffer(int64_t a1);

extern int64_t open_buffer(int64_t a1);

extern void write_byte(int64_t* a1, int64_t a2, int64_t a3);

extern struct let_ret_1 let_module_init(void);

static uint8_t let_module_unload(void);

static uint8_t let_example_3(void);
...
static uint8_t let_example_3(void) {
    {
        goto b1;
b1:;
        int64_t v1_2_0 = open_buffer(INT64_C(1024));
        int64_t v1_3_c = v1_2_0;
        int64_t* v1_3_0 = (&v1_3_c);
        int64_t* v1_4_0 = v1_3_0;
        write_byte(v1_4_0, INT64_C(0), INT64_C(42));
        int64_t v1_8_0 = (*v1_3_0);
        int64_t v1_9_0 = v1_8_0;
        consume_buffer(v1_9_0);
        return INT64_C(0);
    }
}

...
static uint8_t let_show_3(int64_t p1_1);

extern struct let_ret_1 let_module_init(void) {
    {
        goto b1;
b1:;
        int64_t v1_3_0 = let_div(INT64_C(1), INT64_C(0));
        struct let_val_1 v1_4_0 = ((struct let_val_1){v1_3_0});
        let_show_3(v1_3_0);
        struct let_val_2 v1_6_0 = ((struct let_val_2){v1_3_0, v1_4_0, INT64_C(0)});

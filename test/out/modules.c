...
static uint8_t let_show_5_2(void);
...
b1:;
        let_show_5_2();
        return ((struct let_ret_1){((struct let_val_4){((struct let_val_1){INT64_C(0), INT64_C(0)}), ((struct let_val_2){INT64_C(42)}), INT64_C(77), ((struct let_val_3){INT64_C(77)}), INT64_C(0)}), ((struct let_val_4){((struct let_val_1){INT64_C(0), INT64_C(0)}), ((struct let_val_2){INT64_C(42)}), INT64_C(77), ((struct let_val_3){INT64_C(77)}), INT64_C(0)})});
    }
}

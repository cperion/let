...
static int64_t let_run_3(void) {
    {
        goto b1;
b1:;
        int64_t v1_2_c = INT64_C(40);
        int64_t* v1_2_0 = (&v1_2_c);
        int64_t* v1_3_0 = v1_2_0;
        int64_t v1_7_0 = let_bump_4_2(v1_3_0);
        int64_t v1_8_0 = (*v1_2_0);
        int64_t v1_9_0 = LET_ADD(v1_7_0, v1_8_0);
        return v1_9_0;
    }
}
...
b1:;
        int64_t v1_1_0 = (*p1_1);
        int64_t v1_2_0 = LET_ADD(v1_1_0, INT64_C(2));
        (*p1_1) = v1_2_0;
        int64_t v1_4_0 = (*p1_1);
        return v1_4_0;
    }

...
extern int ffi_at(const char* a1, int a2);
...
extern struct let_ret_1 let_module_init(void) {
    {
        goto b1;
b1:;
        const char* v1_2_0 = (((struct let_text){"\101", INT64_C(1)})).data;
        int64_t v1_4_0 = ((int64_t)ffi_at(v1_2_0, ((int)INT64_C(0))));
        int64_t v1_5_0 = ((int64_t)putchar(((int)v1_4_0)));
        struct let_val_1 v1_6_0 = ((struct let_val_1){v1_4_0, v1_5_0});

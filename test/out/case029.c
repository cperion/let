...
struct let_s1 let_module_init(void) {
    {
        ...
        struct let_s3 v5 = ((struct let_s3){.tag = INT64_C(0), .payload = ((union let_u3){.f0 = v1})});
        uint8_t v6 = let_twice_construct();
        struct let_s2 v7 = let_twice_advance_0(v6, v5);
        struct let_s4 v8 = let_twice_advance_1(v7, INT64_C(3));
        int64_t v9 = let_twice_run(v8);
        struct let_s3 v11 = ((struct let_s3){.tag = INT64_C(1), .payload = ((union let_u3){.f1 = v2})});
        uint8_t v12 = let_twice_construct();
        struct let_s2 v13 = let_twice_advance_0(v12, v11);
        struct let_s4 v14 = let_twice_advance_1(v13, INT64_C(3));
        int64_t v15 = let_twice_run(v14);
        int64_t v16 = ((int64_t)(((uint64_t)v9) + ((uint64_t)v15)));
        struct let_s1 v17 = ((struct let_s1){v1, v2, v3, v16});
        return v17;
    }
}

...
#define LET_SUB(a,b) ((int64_t)((uint64_t)(a)-(uint64_t)(b)))
...
static int64_t let_countdown_3(int64_t p1_1);
...
extern struct let_ret_1 let_module_init(void) {
    {
        goto b1;
b1:;
        int64_t v1_4_0 = let_countdown_3(INT64_C(200000));
        struct let_val_1 v1_5_0 = ((struct let_val_1){v1_4_0});
        let_show_4(v1_4_0);
        struct let_val_2 v1_7_0 = ((struct let_val_2){INT64_C(0), v1_4_0, v1_5_0, INT64_C(0)});
...
b4:;
        int64_t v4_3_0 = LET_SUB(p4_1, INT64_C(1));
        {
            int64_t v4_6_t1 = v4_3_0;
            p1_1 = v4_6_t1;
            goto b1;
        }
    }
